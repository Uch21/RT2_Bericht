...
\usepackage[latin1]{inputenc}   	%Verwenden von ä, ö, ü, ß
...
%
\hline
\multicolumn{2}{|p{0.66\textwidth}|}{Gruppenarbeit~\SName}				&Studiensemester:~\SSemester		\\
\hline
Datum:~\VDatum			      &\multicolumn{2}{|l|}{}		\\
\hline
