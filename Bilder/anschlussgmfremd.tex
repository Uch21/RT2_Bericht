...
([xshift = 1.5cm,yshift = 1.5cm]motor.north) node [above] {$U_A$} -- ([xshift = 3cm,yshift = 1.5cm]motor.north);
%
%IA
\draw [-latex,shorten <= 4pt,shorten >=4pt] ([xshift = 0cm,yshift = 1.5cm]motor.north) -- 
([xshift = 0cm,yshift = 0.75cm]motor.north) node [above left] {$I_A$};

%UE
\draw [-latex,shorten <= 4pt,shorten >=4pt] ([xshift = 2.25cm,yshift = 0.5cm]motor.north) -- 
([xshift = 1.25cm,yshift = 0.5cm]motor.north) node [below right] {$U_E$};
%
%IE
\draw [-latex,shorten <= 4pt,shorten >=4pt] ([xshift = 2.25cm,yshift = 0.5cm]motor.north) -- 
([xshift = 2.25cm,yshift = -0.25cm]motor.north) node [right] {$I_E$};
